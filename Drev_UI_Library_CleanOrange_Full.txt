...
-- Drev UI Library mobile toggle
if IsMobile then
    local DrevButton = Instance.new("TextButton")
    DrevButton.Parent = CoreGui
    DrevButton.Name = "Drev"
    DrevButton.Size = UDim2.new(0, 100, 0, 36)
    DrevButton.Position = UDim2.new(0, 20, 0, 40)
    DrevButton.BackgroundColor3 = Color3.fromRGB(255, 140, 0) -- orange
    DrevButton.TextColor3 = Color3.fromRGB(0, 0, 0) -- black
    DrevButton.FontFace = Library and Library.Font or Font.new("rbxasset://fonts/families/SourceSansPro.json")
    DrevButton.Text = "Toggle"
    DrevButton.TextSize = 14
    DrevButton.BorderSizePixel = 0
    DrevButton.AutoButtonColor = false
    DrevButton.ZIndex = 9999

    local visible = true
    DrevButton.Activated:Connect(function()
        visible = not visible
        if Library and Library.Holder and Library.Holder.Instance then
            Library.Holder.Instance.Visible = visible
        end
        if visible then
            DrevButton.BackgroundColor3 = Color3.fromRGB(255, 140, 0)
            DrevButton.Text = "Toggle"
        else
            DrevButton.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
            DrevButton.Text = "Untoggle"
        end
    end)
end
        if visible then
...
local Themes = {
    ["Preset"] = {
        ...
        ["Hovered Element"] = FromRGB(255, 160, 0),
        ["Page Background"] = FromRGB(25, 25, 25),
        ["Outline"] = FromRGB(255, 120, 0),
        ["Element"] = FromRGB(20, 20, 20),
        ["Gradient"] = FromRGB(255, 180, 0),
        ["Text"] = FromRGB(255, 255, 255),
        ["Text Stroke"] = FromRGB(0, 0, 0),
        ["Placeholder Text"] = FromRGB(255, 180, 0),
